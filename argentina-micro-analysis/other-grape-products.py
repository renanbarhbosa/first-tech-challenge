...
if __name__ == "__main__":
    spark = SparkSession.builder.appName("ArgentinaOtherGrapeProductsExports").getOrCreate()
    ...
    try:
        ...
        save_plot(pd_df, 'Year', 'Total_Valor',
                  'Evolução do Valor das Exportações de uvas e derivados para Argentina',
                  'uvas_derivados/exportacoes_uva_derivados_valor.png', 'line')

        save_plot(pd_df, 'Year', 'Total_Quantidade',
                  'Evolução da Quantidade Exportada de uvas e derivados para Argentina',
