...
df = pd.read_csv(r'C:\intellij-projects\postech\first-tech-challenge\wine_exportage_data\table_wine_exportage_data\dados_2024.csv',
...
ax.tick_params(axis='x', labelsize=3.5, pad=3.5)
