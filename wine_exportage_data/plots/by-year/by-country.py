...
if __name__ == "__main__":
    ...
    # ... (Código anterior mantido igual até a criação do pd_df)
    ...
    country_data = pd_df[pd_df['Países'] == 'Países Baixos'].sort_values('Year')

    # Verificar se existem dados para o país
    ...
    os.makedirs("paisesbaixos_analise", exist_ok=True)
    ...
    plt.title('Evolução das Exportações de Vinho da Países Baixos (Valor)', fontsize=16, pad=20)
    ...
    plt.title('Evolução das Exportações de Vinho da Países Baixos (Quantidade)', fontsize=16, pad=20)
    plt.xlabel('Ano', fontsize=12)
