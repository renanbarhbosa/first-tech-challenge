...
if __name__ == "__main__":
    spark = SparkSession.builder.appName("SpainWineExports").getOrCreate()
    ...
    try:
        ...
        save_plot(pd_df, 'Year', 'Total_Valor',
                  'Evolução do Valor das Exportações Vinícolas Espanhois',
                  'vinhos/exportacoes_vinhos_valor.png', 'line')

        save_plot(pd_df, 'Year', 'Total_Quantidade',
                  'Evolução da Quantidade Exportada de Vinhos Espanhois',
